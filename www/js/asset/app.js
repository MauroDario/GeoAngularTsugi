...
myApp.factory('Canchas', function ($http) {
        ...
        Canchas.getDataFromServer = function getDataFromServer() {
            ...
            return $http.get('http://geofutbol.azurewebsites.net/api/canchas/getCahchas/' + lat + '/' + lng + '/' + dist).then(requestSuccessful, requestUnsuccessful);
            ...
            function requestSuccessful(response) {
                ...
                Canchas.list = [{
                    ...
                    "ranking": null,
                    "distancia": 0.034424971220876212 << << << < HEAD
      }, { === === =
            }, { >>> >>> > aa88502350c5f1f40c0a5a587ddde12ae5ba3745
                        ...
                        "longitude": -58.42286,
                        "ranking": null,
                        "distancia": 0.12416465843776053 << << << < HEAD
      }, { === === =
            }, { >>> >>> > aa88502350c5f1f40c0a5a587ddde12ae5ba3745
                        "nombre": "subte",
                        ...
                        "longitude": -58.42171,
                        "ranking": 2,
                        "distancia": 0.3736649078666115 << << << < HEAD
      }, { === === =
            }, { >>> >>> > aa88502350c5f1f40c0a5a587ddde12ae5ba3745
                        "nombre": "Acatraz",
                        ...
                        "longitude": -58.41768,
                        "ranking": null,
                        "distancia": 0.56210209565533376 << << << < HEAD
      }]; === === =
            }]; >>> >>> > aa88502350c5f1f40c0a5a587ddde12ae5ba3745
    }
...
myApp.controller('geoCtrl', function ($scope, Canchas, ngToast, NgMap, $rootScope) {
            ...
            $scope.showInfoWindow = function (event, p) {
                ...
                infowindow.setContent(
                    "<h5>&quot;" + p.nombre + "&quot;</h5>" + "<h5>&quot;" + p.direccion + "&quot;</h5>" + "<h5 class='mdl-typography--text-right'>&quot;" + p.nombre + "&quot;</h5>"
                );
